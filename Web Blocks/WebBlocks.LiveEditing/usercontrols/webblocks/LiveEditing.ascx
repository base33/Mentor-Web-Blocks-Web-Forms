...
<asp:Panel ID="pnlNotLiveEditMode" runat="server">
    <div style="position:fixed;top:0;left:0;z-index:100000;">
        <a href="?liveedit=true" style="float:left;margin:0px 1px;cursor:pointer;color:White;background:orange;padding:5px 10px;border:none;text-align:center;">Edit</a>
        <a href="/umbraco/logout.aspx"
            style="float:left;margin:0px 1px;cursor:pointer;color:White;background:orange;padding:5px 10px;border:none;text-align:center;">Log Out</a>
    </div>
</asp:Panel>
